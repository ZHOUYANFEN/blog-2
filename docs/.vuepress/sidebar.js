module.exports = {
  ...
  /* --------- 必知必会 --------- */
  '/test/linux/': require('../basic-skills/linux/sidebar'),
  '/test/git/': require('../basic-skills/git/sidebar'),
  '/test/nginx/': require('../basic-skills/nginx/sidebar'),
  '/test/docker/': require('../basic-skills/docker/sidebar'),
  /* --------- 编程语言 --------- */
